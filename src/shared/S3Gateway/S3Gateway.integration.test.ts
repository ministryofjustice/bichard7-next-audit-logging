...
const testGateway = new TestS3Gateway(externalIncomingS3Config)
const gateway = new S3Gateway(externalIncomingS3Config)
const secondTestGateway = new TestS3Gateway(internalIncomingS3Config)
